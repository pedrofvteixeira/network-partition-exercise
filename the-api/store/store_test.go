...
func TestCreateOperationSucceedsWithValidName(t *testing.T) {
	actual /*success*/, op := Create("some-valid-name", "some-valid-id")
...
func TestReadAllReturnsAllStoredOperations(t *testing.T) {
	...
	Create("op-01", "upstream-id-01")
	Create("op-02", "upstream-id-02")
	Create("op-03", "upstream-id-03")
...
func TestReadByIdReturnsTheExpectedStoredOperation(t *testing.T) {
	Create("op-01", "upstream-id-01")
	Create("op-02", "upstream-id-02")
	_, createdOp := Create("op-03", "upstream-id-03")
